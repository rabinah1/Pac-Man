...
{
  std::vector<std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string>> points;
  ...
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T1;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T2;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T3;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T4;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T5;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T6;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T7;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T8;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T9;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T10;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T11;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T12;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T13;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T14;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T15;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T16;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T17;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T18;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T19;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T20;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T21;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T22;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T23;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T24;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T25;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T26;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T27;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T28;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T29;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T30;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T31;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T32;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T33;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T34;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T35;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T36;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T37;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T38;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T39;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T40;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T41;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T42;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T43;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T44;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T45;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T46;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T47;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T48;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T49;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T50;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T51;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T52;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T53;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T54;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T55;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T56;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T57;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T58;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T59;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T60;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T61;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T62;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T63;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T64;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T65;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T66;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T67;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T68;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T69;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T70;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T71;
  std::tuple<sf::CircleShape, std::string, std::string, std::string, std::string> T72;
  ...
  point31.setPosition(window.getSize().x/2*1.05, window.getSize().y/2*1.9);
  ...
  point32.setPosition(window.getSize().x/2*0.94, window.getSize().y/2*1.9);
  ...
  point33.setPosition(window.getSize().x/2*0.54, window.getSize().y/2*1.5);
  ...
  point34.setPosition(window.getSize().x/2*0.54, window.getSize().y/2*1.7);
  ...
  point35.setPosition(window.getSize().x/2*0.54, window.getSize().y/2*1.3);
  ...
  point36.setPosition(window.getSize().x/2*0.45, window.getSize().y/2*1.5);
  ...
  point37.setPosition(window.getSize().x/2*0.45, window.getSize().y/2*1.3);
  ...
  point38.setPosition(window.getSize().x/2*0.45, window.getSize().y/2*1.7);
  ...
  point39.setPosition(window.getSize().x/2*0.45, window.getSize().y/2*1.9);
  ...
  point40.setPosition(window.getSize().x/2*1.55, window.getSize().y/2*1.9);
  ...
  point41.setPosition(window.getSize().x/2*1.55, window.getSize().y/2*1.7);
  ...
  point42.setPosition(window.getSize().x/2*1.45, window.getSize().y/2*1.7);
  ...
  point43.setPosition(window.getSize().x/2*1.55, window.getSize().y/2*1.5);
  ...
  point44.setPosition(window.getSize().x/2*1.45, window.getSize().y/2*1.5);
  ...
  point45.setPosition(window.getSize().x/2*1.45, window.getSize().y/2*1.3);
  ...
  point46.setPosition(window.getSize().x/2*1.55, window.getSize().y/2*1.3);
  ...
  point47.setPosition(window.getSize().x/2*1.55, window.getSize().y/2*1.12);
  ...
  point48.setPosition(window.getSize().x/2*1.45, window.getSize().y/2*1.12);
  ...
  T1=std::make_tuple(point1, "Left", "Right", "Up", "None");
  T2=std::make_tuple(point2, "Left", "Right", "Up", "None");
  T3=std::make_tuple(point3, "Left", "Right", "None", "Down");
  T4=std::make_tuple(point4, "Left", "Right", "None", "Down");
  T5=std::make_tuple(point5, "Left", "None", "Up", "Down");
  T6=std::make_tuple(point6, "None", "Right", "Up", "Down");
  T7=std::make_tuple(point7, "None", "Right", "None", "Down");
  T8=std::make_tuple(point8, "Left", "None", "None", "Down");
  T9=std::make_tuple(point9, "Left", "Right", "Up", "None");
  T10=std::make_tuple(point10, "Left", "Right", "Up", "None");
  T11=std::make_tuple(point11, "Left", "Right", "Up", "Down");
  T12=std::make_tuple(point12, "Left", "Right", "Up", "Down");
  T13=std::make_tuple(point13, "None", "Right", "None", "Down");
  T14=std::make_tuple(point14, "Left", "None", "None", "Down");
  T15=std::make_tuple(point15, "Left", "None", "Up", "None");
  T16=std::make_tuple(point16, "None", "Right", "Up", "None");
  T17=std::make_tuple(point17, "None", "Right", "Up", "None");
  T18=std::make_tuple(point18, "Left", "None", "Up", "None");
  T19=std::make_tuple(point19, "Left", "None", "Up", "Down");
  T20=std::make_tuple(point20, "None", "Right", "Up", "Down");
  T21=std::make_tuple(point21, "None", "Right", "Up", "Down");
  T22=std::make_tuple(point22, "Left", "None", "Up", "Down");
  T23=std::make_tuple(point23, "Left", "None", "None", "Down");
  T24=std::make_tuple(point24, "None", "Right", "None", "Down");
  T25=std::make_tuple(point25, "Left", "Right", "Up", "None");
  T26=std::make_tuple(point26, "Left", "Right", "Up", "None");
  T27=std::make_tuple(point27, "None", "Right", "None", "Down");
  T28=std::make_tuple(point28, "Left", "None", "None", "Down");
  T29=std::make_tuple(point29, "Left", "None", "Up", "None");
  T30=std::make_tuple(point30, "None", "Right", "Up", "None");
  T31=std::make_tuple(point31, "Left", "Right", "Up", "None");
  T32=std::make_tuple(point32, "Left", "Right", "Up", "None");
  T33=std::make_tuple(point33, "Left", "None", "None", "Down");
  T34=std::make_tuple(point34, "Left", "Right", "Up", "None");
  T35=std::make_tuple(point35, "Left", "Right", "Up", "None");
  T36=std::make_tuple(point36, "None", "Right", "Up", "None");
  T37=std::make_tuple(point37, "None", "Right", "None", "Down");
  T38=std::make_tuple(point38, "None", "Right", "None", "Down");
  T39=std::make_tuple(point39, "None", "Right", "Up", "None");
  T40=std::make_tuple(point40, "Left", "None", "Up", "None");
  T41=std::make_tuple(point41, "Left", "None", "None", "Down");
  T42=std::make_tuple(point42, "Left", "Right", "Up", "None");
  T43=std::make_tuple(point43, "Left", "None", "Up", "None");
  T44=std::make_tuple(point44, "None", "Right", "None", "Down");
  T45=std::make_tuple(point45, "Left", "Right", "Up", "None");
  T46=std::make_tuple(point46, "Left", "None", "None", "Down");
  T47=std::make_tuple(point47, "Left", "None", "Up", "None");
  T48=std::make_tuple(point48, "None", "Right", "None", "Down");
  T49=std::make_tuple(point49, "None", "Right", "Up", "None");
  T50=std::make_tuple(point50, "Left", "None", "None", "Down");
  T51=std::make_tuple(point51, "Left", "Right", "Up", "Down");
  T52=std::make_tuple(point52, "None", "Right", "Up", "Down");
  T53=std::make_tuple(point53, "Left", "Right", "Up", "Down");
  T54=std::make_tuple(point54, "Left", "None", "Up", "Down");
  T55=std::make_tuple(point55, "Left", "None", "Up", "Down");
  T56=std::make_tuple(point56, "None", "Right", "Up", "Down");
  T57=std::make_tuple(point57, "None", "Right", "Up", "Down");
  T58=std::make_tuple(point58, "Left", "None", "Up", "Down");
  T59=std::make_tuple(point59, "None", "Right", "Up", "Down");
  T60=std::make_tuple(point60, "Left", "Right", "Up", "Down");
  T61=std::make_tuple(point61, "Left", "Right", "None", "Down");
  T62=std::make_tuple(point62, "Left", "Right", "Up", "None");
  T63=std::make_tuple(point63, "Left", "Right", "Up", "None");
  T64=std::make_tuple(point64, "Left", "Right", "None", "Down");
  T65=std::make_tuple(point65, "Left", "Right", "Up", "Down");
  T66=std::make_tuple(point66, "Left", "None", "Up", "Down");
  T67=std::make_tuple(point67, "Left", "Right", "None", "Down");
  T68=std::make_tuple(point68, "Left", "None", "None", "Down");
  T69=std::make_tuple(point69, "None", "Right", "None", "Down");
  T70=std::make_tuple(point70, "Left", "Right", "None", "Down");
  T71=std::make_tuple(point71, "Left", "None", "None", "Down");
  T72=std::make_tuple(point72, "None", "Right", "None", "Down");
